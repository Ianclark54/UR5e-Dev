...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__create(void)
{
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Request * msg = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Request *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request));
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__init(msg);
  if (!success) {
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__destroy(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__init(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Request * data = NULL;

  if (size) {
    data = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Request *)allocator.zero_allocate(size, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__fini(&data[i - 1]);
      }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__fini(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * array = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__init(array, size);
  if (!success) {
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__destroy(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__are_equal(const ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * lhs, const ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Request * data =
      (ur5e_waypoint_mover__srv__ExecuteWaypoints_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__copy(
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__init(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__fini(msg);
    return false;
  }
  // waypoints_executed
  return true;
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__are_equal(const ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * lhs, const ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * rhs)
{
  ...
  // waypoints_executed
  if (lhs->waypoints_executed != rhs->waypoints_executed) {
    return false;
  }
  return true;
}
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * output)
{
  ...
  // waypoints_executed
  output->waypoints_executed = input->waypoints_executed;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * msg = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Response *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response));
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__init(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * data = NULL;

  if (size) {
    data = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Response *)allocator.zero_allocate(size, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__fini(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * array = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__destroy(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__are_equal(const ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * lhs, const ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Response * data =
      (ur5e_waypoint_mover__srv__ExecuteWaypoints_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__init(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(msg);
    return false;
  }
  // request
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__init(&msg->request, 0)) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(msg);
    return false;
  }
  // response
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__init(&msg->response, 0)) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(msg);
    return false;
  }
  return true;
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * msg)
{
  ...
  // request
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__fini(&msg->request);
  // response
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__fini(&msg->response);
}
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__are_equal(const ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * lhs, const ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * rhs)
{
  ...
  // request
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__are_equal(
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * output)
{
  ...
  // request
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * msg = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Event *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event));
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__init(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * data = NULL;

  if (size) {
    data = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Event *)allocator.zero_allocate(size, sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__fini(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * array = (ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence *)allocator.allocate(sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__destroy(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence__are_equal(const ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * lhs, const ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur5e_waypoint_mover__srv__ExecuteWaypoints_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur5e_waypoint_mover__srv__ExecuteWaypoints_Event * data =
      (ur5e_waypoint_mover__srv__ExecuteWaypoints_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur5e_waypoint_mover__srv__ExecuteWaypoints_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
