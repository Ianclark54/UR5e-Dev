...
#ifndef UR5E_WAYPOINT_MOVER__SRV__DETAIL__LIST_WAYPOINTS__FUNCTIONS_H_
#define UR5E_WAYPOINT_MOVER__SRV__DETAIL__LIST_WAYPOINTS__FUNCTIONS_H_
...
/// Initialize srv/ListWaypoints message.
/**
 ...
 * )) before or use
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__create()
...
/// Finalize srv/ListWaypoints message.
/**
...
/// Create srv/ListWaypoints message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__init().
...
/// Destroy srv/ListWaypoints message.
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__fini()
...
/// Check for srv/ListWaypoints message equality.
/**
...
/// Copy a srv/ListWaypoints message.
/**
...
/// Initialize array of srv/ListWaypoints messages.
/**
...
/// Finalize array of srv/ListWaypoints messages.
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__fini()
...
/// Create array of srv/ListWaypoints messages.
/**
 * It allocates the memory for the array and calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ListWaypoints messages.
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ListWaypoints message array equality.
/**
...
/// Copy an array of srv/ListWaypoints messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * ur5e_waypoint_mover__srv__ListWaypoints_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It allocates the memory for the array and calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ur5e_waypoint_mover__srv__ListWaypoints_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It allocates the memory for the array and calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5e_waypoint_mover
...
/**
 * It calls
 * ur5e_waypoint_mover__srv__ListWaypoints_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UR5E_WAYPOINT_MOVER__SRV__DETAIL__LIST_WAYPOINTS__FUNCTIONS_H_
